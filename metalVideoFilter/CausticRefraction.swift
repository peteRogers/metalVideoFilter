...
class CausticRefraction: CIFilter
{
    ...
    override var outputImage: CIImage!
    {
      ...
      let extent = inputImage.extent
        ...
        let refractingImage = CausticNoise()
        refractingImage.inputTime = inputTime
        refractingImage.inputTileSize = inputTileSize
        //  refractingImage.setValue(inputTileSize, forKey: "inputTileSize")
          let gaus = CIFilter(name: "CIGaussianBlur", parameters: [kCIInputRadiusKey: inputSoftening, kCIInputImageKey: refractingImage.outputImage])
